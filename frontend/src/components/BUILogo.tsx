    ...
    return (
      <div className={className} style={{ display: 'inline-flex', ...style }}>
        <svg viewBox="0 0 56 40" width="56" height="40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* B in amber */}
          <text x="7" y="28" fontSize="22" fontWeight="700" fill="#d9861c" fontFamily="Arial, sans-serif">B</text>
          {/* White divider after B */}
          <rect x="24" y="6" width="1.5" height="28" fill="white" />
          {/* UI in amber */}
          <text x="28" y="28" fontSize="22" fontWeight="700" fill="#d9861c" fontFamily="Arial, sans-serif">UI</text>
        </svg>
      </div>
    );
  }
  ...
  return (
    <div className={className} style={{ display: 'inline-flex', ...style }}>
      <svg viewBox="0 0 210 44" width="210" height="44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* "B" in amber */}
        <text x="9" y="31" fontSize="24" fontWeight="700" fill="#d9861c" fontFamily="Arial Black, Arial, sans-serif">B</text>

        {/* White vertical divider after B */}
        <rect x="31" y="7" width="2" height="30" fill="white" opacity="0.85" />

        {/* "UI" in amber */}
        <text x="36" y="31" fontSize="24" fontWeight="700" fill="#d9861c" fontFamily="Arial Black, Arial, sans-serif">UI</text>
